...
<div class="container mx-auto flex flex-wrap py-6">
    ...
    <main class="w-full md:w-3/4 px-2">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold mb-4">Danh Sách Loại sách</h2>
            ...
            <a href="?url=admin/quanlyloaisach/add" class="bg-blue-500 text-white p-2 rounded-md mb-4 inline-block">
            ...
            <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                ...
                <tr>
                    ...
                    <th class="py-2 px-3 border-b border-gray-300 text-left">Tên Loại Sách</th>
                ...
                <?php foreach ($loaiSachs as $loaiSach): ?>
                    <tr class="hover:bg-gray-100">
                        <td class="py-2 px-3 border-b border-gray-300"><?php echo $loaiSach['Id']; ?></td>
                        <td class="py-2 px-3 border-b border-gray-300"><?php echo $loaiSach['TenLoai']; ?></td>
                        <td class="py-2 px-3 border-b border-gray-300 flex space-x-2">
                            <a href="?url=admin/quanlyloaisach/edit&id=<?php echo $loaiSach['Id']; ?>" class="bg-blue-500 text-white p-2 rounded-md flex items-center">
                                <i class="fas fa-edit mr-1"></i> Sửa
                            </a>
                            <button class="bg-red-500 text-white p-2 rounded-md flex items-center" onclick="confirmDelete(<?php echo $loaiSach['Id']; ?>)">
...
<script>
    function confirmDelete(id) {
        ...
        document.getElementById('confirmDeleteBtn').onclick = function () {
            window.location.href = '?url=admin/quanlyloaisach/delete&id=' + id;
        };
    }
