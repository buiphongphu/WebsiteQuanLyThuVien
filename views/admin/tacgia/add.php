    ...
    <div class="container mx-auto flex flex-wrap py-6">
        ...
        <main class="w-full md:w-3/4 px-2">
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-2xl font-bold mb-4">Thêm Tác Giả</h2>
                ...
                <?php endif; ?>
                <form action="?url=admin/quanlytacgia/store" method="post">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="QuocTich" id="QuocTich" class="mt-1 p-2 w-full border border-gray-300 rounded-md">
                        </div>
                    </div>
                    <div class="mt-4 flex justify-between">
                        <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 flex items-center">
                            <i class="fas fa-plus-circle mr-2"></i> Thêm
                        </button>
                        <a href="?url=admin/quanlytacgia" class="bg-gray-500 text-white py-2 px-4 rounded-md hover:bg-gray-600 flex items-center">
