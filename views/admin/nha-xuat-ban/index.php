...
<div class="container mx-auto flex flex-wrap py-6">
    ...
    <main class="w-full md:w-3/4 px-2">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold mb-4">Danh Sách Nhà Xuất Bản</h2>
            ...
            <div class="flex justify-between items-center mb-4">
                <a href="?url=admin/quanlynhaxuatban/add" class="bg-blue-500 text-white p-2 rounded-md mb-4 inline-block">
                    <i class="fas fa-plus"></i> Thêm Nhà Xuất Bản
                </a>
                <div class="flex items-center">
                    <input type="text" id="searchInput" name="keyword" class="border border-gray-300 p-2 rounded-md" placeholder="Tìm kiếm nhà xuất bản...">
            ...
            <div id="searchResults">
                        ...
                        <div class="bg-white shadow-md rounded-lg overflow-x-auto">
                            <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                                ...
                                <tr class="bg-gray-50">
                                    ...
                                    <th class="py-2 px-3 border-b border-gray-300 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tên Nhà Xuất Bản</th>
                                ...
                                <?php foreach ($nhaxuatbans as $nxb): ?>
                                    <tr class="hover:bg-gray-100">
                                        <td class="py-2 px-3 border-b border-gray-300 text-sm text-gray-900"><?php echo $nxb['Id']; ?></td>
                                        <td class="py-2 px-3 border-b border-gray-300 text-sm text-gray-900"><?php echo $nxb['TenNXB']; ?></td>
                                        <td class="py-2 px-3 border-b border-gray-300 text-sm text-gray-900"><?php echo $nxb['DiaChiNXB']; ?></td>
                                        <td class="py-2 px-3 border-b border-gray-300 flex space-x-2">
                                            <a href="?url=admin/quanlynhaxuatban/edit&id=<?php echo $nxb['Id']; ?>" class="bg-blue-500 text-white p-2 rounded-md flex items-center">
                                                <i class="fas fa-edit mr-1"></i> Sửa
                                            </a>
                                            <button class="bg-red-500 text-white p-2 rounded-md flex items-center" onclick="confirmDelete(<?php echo $nxb['Id']; ?>)">
                ...
                <?php else: ?>
                    <p>Không có nhà xuất bản nào được tìm thấy.</p>
                <?php endif; ?>
            </div>
        </div>
    </main>
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Xóa Nhà Xuất Bản</h3>
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">Bạn có chắc chắn muốn xóa nhà xuất bản này? Thao tác này không thể hoàn tác.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function confirmDelete(id) {
        ...
        document.getElementById('confirmDeleteBtn').onclick = function () {
            window.location.href = '?url=admin/quanlynhaxuatban/delete&id=' + id;
        };
    }

    function searchDocGia() {
        const keyword = document.getElementById('searchInput').value;
        fetch('?url=admin/quanlynhaxuatban/search', {
            method: 'POST',
            headers: {
            ...
            .then(data => {
                ...
                <tr>
                    ...
                    <th class="py-2 px-3 border-b border-gray-300 text-left">Tên Nhà Xuất Bản</th>
            ...
            `;
                    ...
                    data.forEach(nxb => {
                        ...
                        tr.innerHTML = `
                    <td class="py-2 px-3 border-b border-gray-300">${nxb.Id}</td>
                    <td class="py-2 px-3 border-b border-gray-300">${nxb.TenNXB}</td>
                    <td class="py-2 px-3 border-b border-gray-300">${nxb.DiaChiNXB}</td>
                    <td class="py-2 px-3 border-b border-gray-300 flex space-x-2">
                        <a href="?url=admin/quanlynhaxuatban/edit&id=${nxb.Id}" class="bg-blue-500 text-white p-2 rounded-md flex items-center">
                            <i class="fas fa-edit mr-1"></i> Sửa
                        </a>
                        <button class="bg-red-500 text-white p-2 rounded-md flex items-center" onclick="confirmDelete(${nxb.Id})">
                            <i class="fas fa-trash-alt mr-1"></i> Xóa
                        </button>
                    </td>
                `;
                    ...
                    searchResults.innerHTML = '<p>Không có nhà xuất bản nào được tìm thấy.</p>';
                }
            })
