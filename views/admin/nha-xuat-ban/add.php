    ...
    <div class="container mx-auto flex flex-wrap py-6">
        ...
        <main class="w-full md:w-3/4 px-2">
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-2xl font-bold mb-4">Thêm Nhà Xuất Bản</h2>
                ...
                <?php endif; ?>
                <form action="?url=admin/quanlynhaxuatban/store" method="POST">
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            <label for="TenNXB" class="block text-gray-700 text-sm font-bold mb-2">Tên Nhà Xuất Bản:</label>
                            <input type="text" id="TenNXB" name="TenNXB" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        <div>
                            <label for="DiaChiNXB" class="block text-gray-700 text-sm font-bold mb-2">Địa Chỉ Nhà Xuất Bản:</label>
                            <textarea id="DiaChiNXB" name="DiaChiNXB" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
                        </div>
                    </div>
